 			...
 			<div class="row">
 				...
 				<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
 					...
 					<div class="col-md-4 text-center">
 						...
 						<p><a class="btn btn-default" style="background: #" href="/findAHomePost">View details »</a></p>
 					</div>
 					...
 					<div class="col-md-4 text-center">
 						...
 						<font style="color:#FF0066">  <h3>Help Me Post
 							...
 							<p><a class="btn btn-default" style="background: #" href="/helpMePost">View details »</a></p>
 						</div>
 						...
 						<div class="col-md-4 text-center">
 							...
 							<font style="color:#FF0066">  <h3>Lost Pet Post
 								...
 								<p><a class="btn btn-default" style="background: #" href="/lostPetPost">View details »</a></p>
 							</div>
 						</div> <!-- /.row -->
 					</div>
